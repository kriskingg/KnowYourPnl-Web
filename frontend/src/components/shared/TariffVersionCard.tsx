...
export const TariffVersionCard = ({ version }: { version: TariffVersion }) => (
  <article
    className="border border-[#102A43] bg-white p-4"
  ...
  >
    <div className="flex items-start justify-between gap-3">
      <div>
        ...
        <div className="text-[12px] text-[#486581] mt-1">
    ...
    <div className="mt-3 pt-3 border-t border-[#e5e5df] flex items-center justify-between text-[11px] text-[#486581] uppercase tracking-wider">
