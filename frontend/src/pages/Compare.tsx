...
export const Compare = () => {
  ...
  return (
    <div className=\"mx-auto max-w-7xl px-4 md:px-6 py-10\" data-testid=\"page-compare\">
      ...
      <section className=\"border border-[#0a0a0a] bg-white mb-8\">
        <div className=\"px-4 py-3 border-b border-black kypnl-overline\">Scenario</div>
      ...
      {brokers.length < 2 && (
        <div className=\"mt-8 border border-dashed border-[#0a0a0a] p-6 flex items-start gap-3\" data-testid=\"compare-empty-state\">
          <Info size={16} strokeWidth={1.75} className=\"mt-0.5 text-[#d43325]\" />
