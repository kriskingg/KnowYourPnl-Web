  ...
  return (
    <div className="mx-auto max-w-7xl px-4 md:px-6 py-10" data-testid="page-tariffs-history">
      <header className="border-b border-[#102A43] pb-6 mb-10">
        <div className="kypnl-overline">Model History</div>
        <h1 className="font-editorial text-4xl md:text-5xl font-semibold mt-2">A visible review trail.</h1>
        <p className="text-[14px] text-[#486581] max-w-2xl mt-3">
          A dated record showing when our broker models were reviewed or updated, without disclosing
          the proprietary values and rule-level changes inside each version.
        </p>
      </header>
